            ...
            <form action="" method="POST" class="form-horizontal uniform" enctype="multipart/form-data">
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<span class="help-block">Module Path: <span id="module_exist" class="badge"></span> <span id="module_path"></span></span>
						<span class="help-block">Mapper Path: <span id="mapper_exist" class="badge"></span> <span id="mapper_path"></span></span>
						<button type="button" id="generate_module" class="btn btn-primary" disabled="disabled"
                            name="generate_module">Generate Module</button>
						<button type="button" id="generate_mapper" class="btn btn-primary" disabled="disabled"
                            name="generate_module">Generate Mapper</button>
					</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<span class="help-block">Entity Path: <span id="entity_exist" class="badge"></span> <span id="entity_path"></span></span>
						<span class="help-block">Table Name: <span id="table_exist" class="badge"></span> <span id="table_name"></span></span>
						<button type="button" id="generate_entity" class="btn btn-primary" disabled="disabled"
                            name="generate_entity">Generate Entity</button>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<span class="help-block">Event edit Path: <span id="event_edit_exist" class="badge"></span> <span id="event_edit_path"></span></span>
						<span class="help-block">Event list Path: <span id="event_list_exist" class="badge"></span> <span id="event_list_path"></span></span>
						
						<button type="button" id="generate_event_edit" class="btn btn-primary" disabled="disabled"
                            name="generate_event">Generate Edit file</button>
						<button type="button" id="generate_event_list" class="btn btn-primary" disabled="disabled"
                            name="generate_event">Generate List file</button>
						<button type="button" id="generate_event_action" class="btn btn-primary" disabled="disabled"
                            name="generate_event">Generate text for Action, Menu, Hook</button>
					</div>
				</div>
...
function generate_files(what){
	ls.ajax(aRouter['admin'] + 'ajax/generate_file/', { 'what': what, 'plugin': $('#plugin').val(), 'module':$('#module').val(), 'entity':$('#entity').val(), 'event':$('#event').val()}, function (response) {
...
function check_files(){
	ls.ajax(aRouter['admin'] + 'ajax/check_file/', { 'plugin': $('#plugin').val(), 'module':$('#module').val(), 'entity':$('#entity').val(), 'event':$('#event').val()}, function (response) {
		if (!response.bStateError) {
